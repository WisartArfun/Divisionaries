...
// use crate::connection::trait_user_server::UserServer;


// pub struct BaseServer<C, S> { // QUES: IDEA: common sub type for NormalDivGame & Api Server, a lot of data is the same
...
// impl UserServer for BaseServer<T> { // QUES: how to call new on a trait ???
//     fn new(ip: &str, port: &str) -> Server {
//         log::info!("new BaseServer created");
//         BaseServer{connections: Arc::new(Mutex::new(T::new())), ws_server: }
//     }
